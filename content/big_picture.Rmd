...
Our Interactive dashboard has two components. The [first](link) is an overview of the scope of our dataset. The [second](https://b6vqbw-yawei-huang.shinyapps.io/FinalProjectApp/) is a tool to explore the relationship between our outcome variables and each individual predictor variable. 
