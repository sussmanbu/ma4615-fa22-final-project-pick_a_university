...
In this post, we brainstormed 10 potential ideas for interactive. We will keeping thinking and discussing these ideas. In the end, some of these ideas might be combined together to serve as the basis of our interactive. 
...
### Interactive:
Input will be mouse based. Zooms into colleges for state(s), or US regions (the Northeast, Southwest, West). Output will be a display of relevant infomation if mouse hovers on top/clicks the university.
