...
```{r, echo=TRUE, message = TRUE, collapse=TRUE}
suppressWarnings({
...
### Limitation 1. 
One of the main limitations is that for our models we don’t introduce any categorical variables. We address this in the Feature Extraction section.
