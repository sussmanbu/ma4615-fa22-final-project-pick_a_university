...
### Finally, this is the codebook for our final dataset (`clean_data.RData`). 

The first column has the final set of variables included in our dataset. The second column explains what each variable means. The third column presents possible values/levels for the variable.

<br>

```{r codebook, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Variable Name                 | Description                                               | Values/Levels       |
|-------------------------------|-----------------------------------------------------------|---------------------|
| university                    | name of the institution                                   |                     |
| city                          | city                                                      |                     |
| state                         | state                                                     |                     |
| international_students_natlib | proportion of international students at the institution   | range from x to x   |
| international_students_max    | number of international students at the institution       | range from x to x   |
...
| international_students_natlib | percentage of international students at the institution   | $1600               |
| international_students_max    | number of international students at the institution       |   $12               |
